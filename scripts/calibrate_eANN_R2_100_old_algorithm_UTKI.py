...
############## To get started ################
#  python-jl calibrate_eANN_R2_100_old_algorithm_UTKI.py --echo

## Global paths
TAG = 'utki'
base_path = '/scratch/pp2681/mom6/CM26_Double_Gyre/calibration/hundred-years'
optimization_folder = 'R2-old-algorithm-UTKI'
...
Main.eval("""
    ...
    y, Diagonal(Γ), TransformUnscented(prior, impose_prior=true),
