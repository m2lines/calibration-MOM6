...
optimization_idx = 'MFC-EKI-ens-size-20'
N_iterations = 5
...
for iteration in range(N_iterations):
    ...
    if os.path.exists(iteration_path):
        ...
        for ens_member, param in enumerate(params.T):
            ...
            hpc = HPC.add(name='MFC', mem=2, ntasks=4, time=2, executable='/home/pp2681/MOM6-examples/build/compiled_executables/MOM6-ZB-2023')
        ...
        os.system(f'cd /home/pp2681/calibration/scripts; sbatch --mem=16GB --dependency=singleton --export=NONE --job-name=MFC -o {base_path}/{optimization_idx}/slurm-%j.out --wrap="python-jl calibrate_DG-MFC.py"')
