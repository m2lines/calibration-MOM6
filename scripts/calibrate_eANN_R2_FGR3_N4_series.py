...
############## To get started ################
#  python-jl calibrate_eANN_R2_FGR3_N4_series.py --echo

## Global paths
TAG = 'N4'
base_path = '/scratch/pp2681/mom6/CM26_Double_Gyre/calibration/20-years'
optimization_folder = 'R2_FGR3_N4_series'
ANN_default_path = '/scratch/pp2681/mom6/CM26_ML_models/ocean3d/subfilter/FGR3/equivariant/learning_rate/N4-forcing-fluxes/0.05/model/'
    ...
    if os.path.exists(iteration_path):
        ...
        for ens_member, param in enumerate(params.T):
            for RR in ['R2']:
                ...
                weights_netcdf['weights2'] = xr.DataArray(param[:24], dims='pdim2')
                weights_netcdf['biases2'] = xr.DataArray(param[24:25], dims='pdim4')
