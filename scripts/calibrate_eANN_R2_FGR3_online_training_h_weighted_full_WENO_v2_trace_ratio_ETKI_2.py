...
############## To get started ################
#  python-jl calibrate_eANN_R2_FGR3_online_training_h_weighted_full_WENO_v2_trace_ratio_ETKI_2.py --echo

## Global paths
TAG = 'TR2'
base_path = '/scratch/pp2681/mom6/CM26_Double_Gyre/calibration/online_training'
optimization_folder = 'R2_FGR3_h_weighted_full_WENO_v2_trace_ratio_ETKI_2'
