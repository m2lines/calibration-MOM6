...
############## To get started ################
#  python-jl calibrate_eANN_R2_100_old_algorithm_v2_ens30_localizer.py --echo

## Global paths
TAG = 'e30l'
base_path = '/scratch/pp2681/mom6/CM26_Double_Gyre/calibration/hundred-years'
optimization_folder = 'R2-old-algorithm-v2-ens-30-localizer'
...
def generate_ensemble_for_parameter_vector(parameter_key):
    ...
    random_perturbation = ENS_SPREAD * parameter_scale * np.random.randn(n_param, 100)[:,0:N_ensemble]
