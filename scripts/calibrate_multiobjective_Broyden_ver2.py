...
############## To get started ################
#  python calibrate_multiobjective_Broyden_ver2.py --echo
...
optimization_folder = 'Broyden-LM-1.0-ver2-e-mean-std-spread-0.1'
...
J_initial = cov_yy @ np.linalg.pinv(cov_xy)

# This is only for regulatization of LM update
cov_xx_new = cov_xy @ np.linalg.pinv(J_initial.T)
