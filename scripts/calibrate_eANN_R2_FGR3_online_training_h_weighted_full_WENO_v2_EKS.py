...
############## To get started ################
#  python-jl calibrate_eANN_R2_FGR3_online_training_h_weighted_full_WENO_v2_EKS.py --echo

## Global paths
TAG = 'eks'
base_path = '/scratch/pp2681/mom6/CM26_Double_Gyre/calibration/online_training'
optimization_folder = 'R2_FGR3_h_weighted_full_WENO_v2_EKS'
...
commandline = f'cd /home/pp2681/calibration/scripts; sbatch --time=00:30:00 --cpus-per-task=4 --mem=64GB --dependency=singleton --export=NONE --job-name={TAG} -o {base_path}/{optimization_folder}/slurm-%j.out -e {base_path}/{optimization_folder}/slurm-%j.err --wrap="python-jl {script_name}"'
