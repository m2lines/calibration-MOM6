Repository supporting paper "Improving the mean state and variability of an idealized ocean model as a calibration problem" by Pavel Perezhogin, Alistair Adcroft and Laure Zanna.
...
* Implementation of the equivariant neural network: [ann_tools.py](https://github.com/m2lines/calibration-MOM6/blob/publication/scripts/ann_tools.py#L139-L185)
